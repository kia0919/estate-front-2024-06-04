...
export const GET_LOCAL_DATA_URL = (local: string) => `${SERVER_ESTATE_MODULT_URL}/local/${local}`;
export const GET_RATIO_DATA_URL = (local: string) => `${SERVER_ESTATE_MODULT_URL}/ratio/${local}`;
